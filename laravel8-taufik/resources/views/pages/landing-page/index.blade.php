            ...
            <div>
                <div class="mx-auto flex pt-12 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
                        ...
                        <div
                            ...
                            <button
                                ...
                                <img style="height: 20px;" class="mr-2" src="{{ asset('/assets/img/icon-1.png')}}" alt="" />
                                    {{-- <img style="height: 20px;" class="mr-2" src="https://github.com/jiboncoco/class-bwa-eloquent-orm-tails-freemium/blob/main/assets/img/icon-1.png?raw=true" alt="" /> --}}
                                    Tables
                                </div>
                            </button>
                        </div>
                    ...
                    <div class="w-full lg:w-1/2 text-center justify-center flex pr-0">
                        ...
                        {{-- <img id="hero-header-2-3" src="https://raw.githubusercontent.com/jiboncoco/class-bwa-eloquent-orm-tails-freemium/709cb089e0525b4c55f79f09119184849cfc8a3c/assets/img/hero-1.svg" alt="" title="" /> --}}
                    </div>
                </div>
            </div>
        </div>
